...
export default function CommunityScreen() {
  ...
  const messages = [
    { username: 'Momin123', message: 'Scored a 100 today!' },
    { username: 'Umer593', message: 'Anybody wanna go for a net session?' },
    { username: 'Ibrahim62', message: 'Yes, I am available' },
    { username: 'Tanzeel25', message: 'Our match got cancelled, we have a ground booking on Sunday 8-12 in Pasban. Any team available?' },
    { username: 'Momin123', message: 'Scored a 100 today!' },
    { username: 'Umer593', message: 'Anybody wanna go for a net session?' },
    { username: 'Ibrahim62', message: 'Yes, I am available' },
    { username: 'Tanzeel25', message: 'Our match got cancelled, we have a ground booking on Sunday 8-12 in Pasban. Any team available?' },
